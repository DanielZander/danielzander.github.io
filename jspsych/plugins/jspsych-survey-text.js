  ...
  plugin.trial = function(display_element, trial) {
    ...
    for (var i = 0; i < trial.questions.length; i++) {
      ...
      if(question.rows == 1){
        ...
        html += '<textarea id="input-'+question_index+'" name="#jspsych-survey-text-costum-response-' + question_index + '" data-name="'+question.name+'" cols="' + question.columns + '" rows="' + question.rows + '" '+autofocus+' '+req+'></textarea>';
      }
